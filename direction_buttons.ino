...
void drawButtons() {
  ...
  uint16_t bHeight = TFT_WIDTH/3;
  
  //Generate up button
  key[0].initButton(&tft,
                    bWidth * (1) + bWidth/2,
                    bHeight * (1/3) + bHeight/2,
                    bWidth/1.5,
                    bHeight/1.5,
                    TFT_BLACK, // Outline
                    TFT_BLUE, // Fill
  ...
  key[2].initButton(&tft,
                    ...
                    "",
                    1);
  key[2].drawButton(false, ">");

  //Generate down button
  key[0].initButton(&tft,
                    bWidth * (1) + bWidth/2,
                    bHeight * (2) + bHeight/2,
                    bWidth/1.5,
  ...
  //   //Decides What goes on the buttons
